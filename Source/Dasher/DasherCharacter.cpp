...
void ADasherCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &ADasherCharacter::Look);
...
void ADasherCharacter::DoMove(float Right, float Forward)
{
...
void ADasherCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void ADasherCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void ADasherCharacter::DoJumpEnd()
{
